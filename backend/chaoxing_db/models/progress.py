...
class StudentSectionProgress(Base):
    ...
    pace_mode: Mapped[str | None] = mapped_column(String(32))
    pace_reason_summary: Mapped[str | None] = mapped_column(String(255))
    pace_trigger_source: Mapped[str | None] = mapped_column(String(32))
    pace_updated_at: Mapped[datetime | None] = mapped_column(DateTime)
